...
/**
 * This class serves as a viewer for the UIModel. It is controlled by the FlightBuilder. The form, components,
 * and constructor were all automatically generated by the GUI Designer (WYSIWYG). This class passes user input
 * to the model, retrieves display values from the model, and activates the controller when the user requests
 * functionality.
 *
...
public class ReservationApp {
     ...
     * Also, stores a reference to a UIModel object for storage and validation of input
     *
     * @param newModel a UIModel to store and validate user input
     */
    ...
    public ReservationApp() {
        ...
        searchForFlightsButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                busy(true);
                FlightBuilder.searchForFlights();
                buildFlightTable();
                busy(false);
            }
        });
